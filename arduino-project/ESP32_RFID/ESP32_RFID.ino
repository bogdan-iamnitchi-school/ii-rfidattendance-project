...
// --------------------------------GLOBAL VARIABLES------------------------------------------
//ESP32 ---------------------------
// const char *ssid = "DIGI-JzF9";
// const char *password = "czj9Vtjd7W";
// String URL = "http://192.168.1.141/rfidattendance/getdata.php"; //computer IP or the server domain
...
const char *device_token  = "ddf3ab7863389e6e";
String getData, Link;
String OldCardID = "";
